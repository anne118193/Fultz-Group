...
#Sp_parms = {'LogName':"BL18:SE:LS2:KRDG3", 'LogValueInterval':5,'MinimumLogValue':247.5, 
#            'MaximumLogValue':442.5, 'FilterLogValueByChangingDirection':'Increase'} # temperature splitting #parameters
DGSdict = {}
DGSdict['EnergyTransferRange'] = [-50.0,0.1,50.0] #Energy Binning
Bining_2D = {'AlignedDim0':'|Q|,0.0,10,100', 'AlignedDim1':'DeltaE,-50.1,50.1,1001'}
mde_pth = os.path.join('camille/Pb/50mev/qcuts','mdes_liquid','')
#========================================
...
#Ei = 49.486036563730934
#T0 = 35.75024684454365
...
#msi.GenerateEventsFilter(InputWorkspace='pre_split', OutputWorkspace='evf', InformationWorkspace='evf_info', TimeInterval=sp_dt)
#TimeInterval=sp_dt)
#TempInterval=Sp_parms
#msi.FilterEvents(InputWorkspace='pre_split', SplitterWorkspace='evf', 
#OutputWorkspaceBaseName='split', InformationWorkspace='evf_info', FilterByPulseTime=True, GroupWorkspaces=True)
...
minvals,maxvals=msi.ConvertToMDMinMaxGlobal('pre_split','|Q|','Direct')
...
try:
    ...
    os.mkdir(mde_dir)
fstr = mde_dir+'/'+'603K_bkg_md.h5'
msi.SaveMD(Inputworkspace='SQE_rebinned', Filename=fstr, SaveHistory=False, SaveInstrument=False, SaveSample=False,SaveLogs=True)
